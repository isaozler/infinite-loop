...
function $31c3583b17e8d606$var$appendArc(values, index) {
    ...
    var path = element === null || element === void 0 ? void 0 : element.append('path').classed('arc', true).attr('d', arcShape).attr('data-json', "".concat(JSON.stringify((/*@__PURE__*/$parcel$interopDefault($660cdcc6ccbb40c0$exports))[$31c3583b17e8d606$var$t] || {}))).attr('data-sa', "".concat(startAngle + angleOffset)).attr('data-ea', "".concat(endAngle + angleOffset)).attr('fill', $31c3583b17e8d606$var$config.colors[half][index]).style('opacity', 0).style('transform', 'scale(1.2)').on('click', function() {
        var isActive = $c6a650051c356b4d$export$2e2bcd8739ae039(this).classed('active');
        var _innerRadius = (isActive ? 0 : 20) + innerRadius;
        var _outerRadius = (isActive ? 0 : 20) + $31c3583b17e8d606$var$config.outerRadius;
        var _startAngle = startAngle + (!isActive ? angleOffset + 0.05 : angleOffset);
        var _endAngle = endAngle + (!isActive ? angleOffset - 0.05 : angleOffset);
        var _$data = JSON.parse($c6a650051c356b4d$export$2e2bcd8739ae039(this).attr('data-json') || "");
        $31c3583b17e8d606$var$resetArcs();
        $c6a650051c356b4d$export$2e2bcd8739ae039(this).classed('active', !isActive).transition().ease($31c3583b17e8d606$var$arcEase).duration($31c3583b17e8d606$var$config.arcTweenTransitionDuration).attr('d', $8b805176339f2cf3$export$2e2bcd8739ae039().innerRadius(_innerRadius).outerRadius(_outerRadius).startAngle(_startAngle).endAngle(_endAngle));
        ...
        if (_$data === null || _$data === void 0 ? void 0 : _$data.src) {
            if (half === 3 || half === 1) $31c3583b17e8d606$var$imageRight === null || $31c3583b17e8d606$var$imageRight === void 0 ? void 0 : $31c3583b17e8d606$var$imageRight.attr('href', _$data.src);
            else $31c3583b17e8d606$var$imageLeft === null || $31c3583b17e8d606$var$imageLeft === void 0 ? void 0 : $31c3583b17e8d606$var$imageLeft.attr('href', _$data.src);
        }
    });
    path === null || path === void 0 ? void 0 : path.append('title').text(((ref = (/*@__PURE__*/$parcel$interopDefault($660cdcc6ccbb40c0$exports))[$31c3583b17e8d606$var$t++]) === null || ref === void 0 ? void 0 : ref.title) || '');
}
function $31c3583b17e8d606$var$resetArcs() {
    $31c3583b17e8d606$var$svg === null || $31c3583b17e8d606$var$svg === void 0 ? void 0 : $31c3583b17e8d606$var$svg.selectAll('.arc').classed('active', false).each(function() {
        var _startAngle = +$c6a650051c356b4d$export$2e2bcd8739ae039(this).attr('data-sa');
        var _endAngle = +$c6a650051c356b4d$export$2e2bcd8739ae039(this).attr('data-ea');
        $c6a650051c356b4d$export$2e2bcd8739ae039(this).classed('active', false).transition().ease($31c3583b17e8d606$var$arcEase).duration($31c3583b17e8d606$var$config.arcTweenTransitionDuration).attr('d', $8b805176339f2cf3$export$2e2bcd8739ae039().innerRadius($31c3583b17e8d606$var$config.outerRadius - $31c3583b17e8d606$var$config.arcWidth).outerRadius($31c3583b17e8d606$var$config.outerRadius).startAngle(_startAngle).endAngle(_endAngle));
    });
}
function $31c3583b17e8d606$var$animateGroups() {
    [
        ...
        $31c3583b17e8d606$var$svg === null || $31c3583b17e8d606$var$svg === void 0 ? void 0 : $31c3583b17e8d606$var$svg.selectAll('.group' + half).each(function() {
            var arcs = $c6a650051c356b4d$export$2e2bcd8739ae039(this).selectAll('.arc').each(function(_, i, all) {
                $c6a650051c356b4d$export$2e2bcd8739ae039(this).transition().duration($31c3583b17e8d606$var$config.arcTransitionDelay * 2).delay(index * (all.length * $31c3583b17e8d606$var$config.arcTransitionDelay) + (half === 3 || half == 1 ? i = all.length - 1 - i : i) * $31c3583b17e8d606$var$config.arcTransitionDelay).style('opacity', 1).style('transform', 'scale(1)');
            });
        });
    });
}
...
//# sourceMappingURL=index.bbed4331.js.map
